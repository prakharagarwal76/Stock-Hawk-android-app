...
public class StockWidgetProvider extends AppWidgetProvider {
    ...
    public static final String EXTRA_NAME = "com.sam_chordas.android.stockhawk.widget.StockWidgetProvider.EXTRA_NAME";
    public static final String EXTRA_CURRENCY = "com.sam_chordas.android.stockhawk.widget.StockWidgetProvider.EXTRA_CURRENCY";
    public static final String EXTRA_LASTTRADEDATE = "com.sam_chordas.android.stockhawk.widget.StockWidgetProvider.EXTRA_LASTTRADEDATE";
    public static final String EXTRA_DAYLOW = "com.sam_chordas.android.stockhawk.widget.StockWidgetProvider.EXTRA_DAYLOW";
    public static final String EXTRA_DAYHIGH = "com.sam_chordas.android.stockhawk.widget.StockWidgetProvider.EXTRA_DAYHIGH";
    public static final String EXTRA_YEARLOW = "com.sam_chordas.android.stockhawk.widget.StockWidgetProvider.EXTRA_YEARLOW";
    public static final String EXTRA_YEARHIGH = "com.sam_chordas.android.stockhawk.widget.StockWidgetProvider.EXTRA_YEARHIGH";
    public static final String EXTRA_EARNINGSSHARE = "com.sam_chordas.android.stockhawk.widget.StockWidgetProvider.EXTRA_EARNINGSSHARE";
    public static final String EXTRA_MARKETCAPITALIZATION = "com.sam_chordas.android.stockhawk.widget.StockWidgetProvider.EXTRA_MARKETCAPITALIZATION";
